...
|----------------------------------------|----------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|
| [!UICONTROL Import Amazon Orders] | `Enabled` | Crea corrispondenti [!DNL Commerce] ordini quando vengono ricevuti nuovi ordini da Amazon, consentendo la gestione degli ordini in [[!DNL Commerce] Ordini](https://experienceleague.adobe.com/docs/commerce-admin/stores-sales/order-management/orders/orders.html) flusso di lavoro. Quando `Disabled`, Amazon ordina le informazioni sugli ordini di importazione per la revisione, ma gli ordini devono essere gestiti nel [!DNL Amazon Seller Central] account. | [Impostazioni ordine](./order-settings.md) |
