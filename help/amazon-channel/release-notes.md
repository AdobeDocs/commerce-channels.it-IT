...
![Problema risolto](../assets/fix.svg) Riduzione del rumore nei log.

![Problema risolto](../assets/fix.svg) È stata migliorata la stabilità del richiamo degli aggiornamenti.

![Problema risolto](../assets/fix.svg) È stato semplificato il processo per l’esecuzione di un’azione pull singola o per l’applicazione da CLI.

![Problema risolto](../assets/fix.svg) È stata aggiornata la dipendenza per `magento/services-connector`.

![Problema risolto](../assets/fix.svg) Sono stati risolti i problemi di sincronizzazione negli account britannici con codice paese non valido.

![Problema risolto](../assets/fix.svg) Se l&#39;entità entity_type_id viene codificata in modo rigido per l&#39;entità prodotto catalogo, si verificano problemi con l&#39;origine prezzo Magento.

![Problema risolto](../assets/fix.svg) È stato corretto un problema che impediva l’eliminazione dall’interfaccia utente degli account eliminati su un backend da un’altra istanza.

![Problema risolto](../assets/fix.svg) È stato risolto un problema relativo ad alcune regole del carrello che interrompevano l’importazione dell’ordine.
...
Se hai un [!DNL Amazon sales channel] È stata installata la versione e si tenta di aggiornare Adobe Commerce alla versione 2.4.0. Viene richiesto di aggiornare l’estensione prima di completare l’aggiornamento Adobe Commerce.
...
- [Codice fiscale prodotto](https://sellercentral.amazon.com/gp/help/help.html?itemID=G200794510&amp;language=en_US){target="_blank"} informazioni.
