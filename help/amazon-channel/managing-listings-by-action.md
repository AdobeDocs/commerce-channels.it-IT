...
| [[!UICONTROL Update Required Info]](./amazon-manually-update-incomplete-listing.md) | Corrispondenza manuale dei prodotti del catalogo con gli elenchi di Amazon selezionando un elenco a cui associare, immettendo un ASIN a cui associare o assegnando una condizione mancante. | [[!UICONTROL Incomplete]](./incomplete-listings.md) |
